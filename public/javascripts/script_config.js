...
Talho.ScriptManager.addInitializer('Talho.TALHO.controller.Teleconference', {js: '$(t_cont)/Teleconference.js $(t_view)/forms/Teleconference.js'});
Talho.ScriptManager.addInitializer('Talho.TALHO.controller.VideoConference', {js: '$(t_cont)/VideoConference.js $(t_view)/forms/VideoConference.js'});
