...
dominoes.property('talho', '/javascripts/talho');
...
Talho.ScriptManager.addInitializer('Talho.TALHO.controller.Teleconference', {js: '/javascripts/ext_extensions/validations.js > $(t_cont)/Teleconference.js $(t_view)/forms/Teleconference.js'});
Talho.ScriptManager.addInitializer('Talho.TALHO.controller.VideoConference', {js: '$(ext_extensions)/RowEditor.js /javascripts/ext_extensions/validations.js > $(t_cont)/VideoConference.js $(t_view)/forms/VideoConference.js'});
