...
talho.logo = File.open(Rails.root.join('app','assets','images','talho_phin','talho_phin_title.jpg')) if talho.logo_file_name.blank?
talho.tiny_logo = File.open(Rails.root.join('app','assets','images','images','talho_header_logo.png')) if talho.tiny_logo_file_name.blank?
talho.about_label = 'About OpenPHIN' if talho.about_label.blank?
talho.about_text = %Q{<h1>About OpenPHIN</h1>
...
<p>Copyright &cp; 2009 - 2011 Texas Association of Local Health Officials - All Rights Reserved</p>} if talho.about_text.blank?
